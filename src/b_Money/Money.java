...
public class Money implements Comparable {
	...
	public String toString() {
		int natural = amount / 100;
		int decimals = amount % 10;
		return ""+ natural + "." + decimals + " " + currency.getName();
	}
	...
	public Money add(Money other) {
		int otherAmount = currency.valueInThisCurrency(other.amount, other.currency);
		Money money = new Money(this.getAmount()+otherAmount, this.currency);
		return money;
	}
	...
	public Money sub(Money other) {
		int otherAmount = currency.valueInThisCurrency(other.amount, other.currency);
		Money money = new Money(this.getAmount().intValue()-otherAmount, this.currency);
		return money;
	}
